...
static void _search_dialg_search_gtk_button_clicked (GtkButton* _sender,
                                              gpointer self);
static void __lambda28_ (SearchDialg* self,
                  gint rid);
static void ___lambda28__gtk_dialog_response (GtkDialog* _sender,
                                       gint response_id,
                                       gpointer self);
...
void my_grid_add_friend (MyGrid* self,
                         UserMsg* user1,
                         gboolean tell);
static void ___lambda29__gtk_tree_view_row_activated (GtkTreeView* _sender,
                                               GtkTreePath* path,
...
static void
___lambda28__gtk_dialog_response (GtkDialog* _sender,
                                  gint response_id,
                                  gpointer self)
{
	__lambda28_ ((SearchDialg*) self, response_id);
}
...
static void
___lambda29__gtk_tree_view_row_activated (GtkTreeView* _sender,
                                          GtkTreePath* path,
                                          GtkTreeViewColumn* column,
                                          gpointer self)
{
	__lambda29_ ((SearchDialg*) self, _sender, path, column);
}
...
search_dialg_construct (GType object_type)
{
	...
	_tmp28_ = self->dlg1;
	g_signal_connect_object (_tmp28_, "response", (GCallback) ___lambda28__gtk_dialog_response, self, 0);
	g_signal_connect_object (view, "row-activated", (GCallback) ___lambda29__gtk_tree_view_row_activated, self, 0);
