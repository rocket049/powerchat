...
static gboolean __lambda41_ (MultiSendUi* self,
                      gint64* a,
                      gint64* b);
static gboolean _int64_equal (const gint64 * s1,
                       const gint64 * s2);
static gboolean ___lambda41__gee_equal_data_func (gconstpointer a,
                                           gconstpointer b,
                                           gpointer self);
...
static void __lambda51_ (MultiSendUi* self);
static void multi_send_ui_on_select_destroy (MultiSendUi* self);
static void ___lambda51__gtk_widget_destroy (GtkWidget* _sender,
                                      gpointer self);
static void __lambda46_ (MultiSendUi* self,
                  GtkListBoxRow* r);
...
static gboolean __lambda47_ (MultiSendUi* self,
                      const gchar* a,
                      const gchar* b);
static gboolean ___lambda47__gee_equal_data_func (gconstpointer a,
                                           gconstpointer b,
                                           gpointer self);
static void ___lambda48_ (Block14Data* _data14_,
                   GtkWidget* w);
static void ____lambda48__gtk_callback (GtkWidget* widget,
                                 gpointer self);
static void ____lambda49_ (Block14Data* _data14_,
                    GtkWidget* w);
static void _____lambda49__gtk_callback (GtkWidget* widget,
                                  gpointer self);
static void __lambda44_ (MultiSendUi* self);
static Block15Data* block15_data_ref (Block15Data* _data15_);
static void block15_data_unref (void * _userdata_);
static void __lambda45_ (Block15Data* _data15_);
static void ___lambda45__gtk_entry_activate (GtkEntry* _sender,
                                      gpointer self);
static void ___lambda44__gtk_button_clicked (GtkButton* _sender,
                                      gpointer self);
static void __lambda43_ (MultiSendUi* self);
...
static void __lambda40_ (Block17Data* _data17_,
                  GtkWidget* w);
static void ___lambda40__gtk_callback (GtkWidget* widget,
                                gpointer self);
static gboolean __lambda50_ (MultiSendUi* self,
                      GdkEventButton* e);
void group_popup_set_name (GroupPopup* self,
                           const gchar* name);
static gboolean ___lambda50__gtk_widget_button_release_event (GtkWidget* _sender,
                                                       GdkEventButton* event,
                                                       gpointer self);
static void multi_send_ui_finalize (GObject * obj);
static void __lambda39_ (GroupPopup* self);
...
static gboolean
___lambda41__gee_equal_data_func (gconstpointer a,
                                  gconstpointer b,
                                  gpointer self)
{
	gboolean result;
	result = __lambda41_ ((MultiSendUi*) self, (gint64*) a, (gint64*) b);
	return result;
}
...
static void
___lambda51__gtk_widget_destroy (GtkWidget* _sender,
                                 gpointer self)
{
	__lambda51_ ((MultiSendUi*) self);
}
...
multi_send_ui_construct (GType object_type)
{
	...
	_tmp10_ = gee_hash_set_new (G_TYPE_INT64, (GBoxedCopyFunc) _int64_dup, (GDestroyNotify) g_free, NULL, NULL, NULL, ___lambda41__gee_equal_data_func, g_object_ref (self), g_object_unref);
	...
	g_signal_connect_object ((GtkWidget*) _tmp41_, "destroy", (GCallback) ___lambda51__gtk_widget_destroy, self, 0);
...
___lambda46__gtk_list_box_row_selected (GtkListBox* _sender,
                                        ...
                                        gpointer self)
{
	__lambda46_ ((MultiSendUi*) self, row);
}
...
multi_send_ui_set_group_callback (MultiSendUi* self)
{
	...
	g_signal_connect_object (_tmp0_, "row-selected", (GCallback) ___lambda46__gtk_list_box_row_selected, self, 0);
}
...
block14_data_unref (void * _userdata_)
{
	...
	if (g_atomic_int_dec_and_test (&_data14_->_ref_count_)) {
		MultiSendUi* self;
		self = _data14_->self;
		_g_object_unref0 (_data14_->set1);
...
static gboolean
___lambda47__gee_equal_data_func (gconstpointer a,
                                  gconstpointer b,
                                  gpointer self)
{
	gboolean result;
	result = __lambda47_ ((MultiSendUi*) self, (const gchar*) a, (const gchar*) b);
	return result;
}


static void
___lambda48_ (Block14Data* _data14_,
              GtkWidget* w)
{
	MultiSendUi* self;
...
static void
____lambda48__gtk_callback (GtkWidget* widget,
                            gpointer self)
{
	___lambda48_ (self, widget);
}


static void
____lambda49_ (Block14Data* _data14_,
               GtkWidget* w)
{
	MultiSendUi* self;
	GtkListBoxRow* r = NULL;
...
static void
_____lambda49__gtk_callback (GtkWidget* widget,
                             gpointer self)
{
	____lambda49_ (self, widget);
}
                         ...
                         int ids1_length1)
{
	...
	_tmp0_ = gee_hash_set_new (G_TYPE_STRING, (GBoxedCopyFunc) g_strdup, (GDestroyNotify) g_free, NULL, NULL, NULL, ___lambda47__gee_equal_data_func, g_object_ref (self), g_object_unref);
	_data14_->set1 = _tmp0_;
	{
		gint i = 0;
		i = 0;
		{
	...
	if (_tmp30_ == 1) {
		...
		gtk_container_foreach ((GtkContainer*) _tmp31_, ____lambda48__gtk_callback, _data14_);
	} else {
		gint _tmp32_;
		_tmp32_ = ret;
		if (_tmp32_ == 2) {
			...
			gtk_container_foreach ((GtkContainer*) _tmp33_, _____lambda49__gtk_callback, _data14_);
		}
	}
	_tmp34_ = dlg1;
...
block15_data_unref (void * _userdata_)
{
	...
	if (g_atomic_int_dec_and_test (&_data15_->_ref_count_)) {
		MultiSendUi* self;
		self = _data15_->self;
		_g_object_unref0 (_data15_->name1);
		_g_object_unref0 (self);
...
static void
___lambda45__gtk_entry_activate (GtkEntry* _sender,
                                 gpointer self)
{
	__lambda45_ (self);
}
...
__lambda44_ (MultiSendUi* self)
{
	...
	_g_free0 (_tmp13_);
	_g_free0 (_tmp11_);
	_tmp14_ = _data15_->name1;
	gtk_widget_show ((GtkWidget*) _tmp14_);
	_tmp15_ = _data15_->name1;
	gtk_entry_grab_focus_without_selecting (_tmp15_);
	_tmp16_ = _data15_->name1;
	g_signal_connect_data (_tmp16_, "activate", (GCallback) ___lambda45__gtk_entry_activate, block15_data_ref (_data15_), (GClosureNotify) block15_data_unref, 0);
	block15_data_unref (_data15_);
	_data15_ = NULL;
}
...
multi_send_ui_set_send_callback (MultiSendUi* self)
{
	...
	g_signal_connect_object (_tmp0_, "clicked", (GCallback) ___lambda43__gtk_button_clicked, self, 0);
}
...
block16_data_unref (void * _userdata_)
{
	...
	if (g_atomic_int_dec_and_test (&_data16_->_ref_count_)) {
		MultiSendUi* self;
		self = _data16_->self;
		_g_object_unref0 (_data16_->button1);
		user_msg_destroy (&_data16_->u1);
		_g_object_unref0 (self);
...
__lambda42_ (Block16Data* _data16_)
{
	...
	gboolean _tmp1_;
	self = _data16_->self;
	_tmp0_ = gtk_toggle_button_get_active ((GtkToggleButton*) _data16_->button1);
	_tmp1_ = _tmp0_;
	if (_tmp1_) {
		GeeHashSet* _tmp2_;
		UserMsg _tmp3_;
                          ...
                          UserMsg* u1)
{
	...
	g_object_ref_sink (_tmp4_);
	_data16_->button1 = _tmp4_;
	_tmp5_ = _data16_->u1;
	_tmp6_ = _tmp5_.id;
	_tmp7_ = g_strdup_printf ("%" G_GINT64_FORMAT, _tmp6_);
	_tmp8_ = _tmp7_;
	gtk_widget_set_name ((GtkWidget*) _data16_->button1, _tmp8_);
	_g_free0 (_tmp8_);
	_tmp9_ = self->priv->friends;
	gtk_container_add ((GtkContainer*) _tmp9_, (GtkWidget*) _data16_->button1);
	gtk_widget_show ((GtkWidget*) _data16_->button1);
	_tmp10_ = gtk_widget_get_parent ((GtkWidget*) _data16_->button1);
	_tmp11_ = _tmp10_;
	...
	g_signal_connect_data ((GtkToggleButton*) _data16_->button1, "toggled", (GCallback) ___lambda42__gtk_toggle_button_toggled, block16_data_ref (_data16_), (GClosureNotify) block16_data_unref, 0);
...
static void
__lambda40_ (Block17Data* _data17_,
             GtkWidget* w)
{
	MultiSendUi* self;
	GtkListBoxRow* r = NULL;
	...
	_tmp3_ = _tmp2_;
	if (g_strcmp0 (_tmp3_, _data17_->name) == 0) {
		GtkListBox* _tmp4_;
...
static void
___lambda40__gtk_callback (GtkWidget* widget,
                           gpointer self)
{
	__lambda40_ (self, widget);
}
                                    ...
                                    const gchar* name)
{
	...
	_g_free0 (_data17_->name);
	_data17_->name = _tmp0_;
	_tmp1_ = self->priv->group_map;
	gee_abstract_map_unset ((GeeAbstractMap*) _tmp1_, _data17_->name, NULL);
	_tmp2_ = self->priv->groups;
	gtk_container_foreach ((GtkContainer*) _tmp2_, ___lambda40__gtk_callback, _data17_);
...
static gboolean
___lambda50__gtk_widget_button_release_event (GtkWidget* _sender,
                                              GdkEventButton* event,
                                              gpointer self)
{
	gboolean result;
	result = __lambda50_ ((MultiSendUi*) self, event);
	return result;
}
...
multi_send_ui_set_popup (MultiSendUi* self)
{
	...
	g_return_if_fail (self != NULL);
	_tmp0_ = self->priv->groups;
	g_signal_connect_object ((GtkWidget*) _tmp0_, "button-release-event", (GCallback) ___lambda50__gtk_widget_button_release_event, self, 0);
}
...
group_popup_construct (GType object_type)
{
	...
	g_object_ref_sink (_tmp0_);
	item2 = _tmp0_;
	g_signal_connect_object (item2, "activate", (GCallback) ___lambda39__gtk_menu_item_activate, self, 0);
