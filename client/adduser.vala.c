...
static void ___lambda77__gtk_combo_box_changed (GtkComboBox* _sender,
                                         gpointer self);
...
static void ___lambda79__gtk_dialog_response (GtkDialog* _sender,
                                       gint response_id,
                                       gpointer self);
...
block13_data_unref (void * _userdata_)
{
	...
	if (g_atomic_int_dec_and_test (&_data13_->_ref_count_)) {
		AddUserDialog* self;
		self = _data13_->self;
		_g_object_unref0 (_data13_->sexSelect);
		_g_object_unref0 (_data13_->yearSelect);
		_g_object_unref0 (_data13_->cfpwd);
...
static void
___lambda77__gtk_combo_box_changed (GtkComboBox* _sender,
                                    gpointer self)
{
	__lambda77_ (self);
}
...
__lambda78_ (Block13Data* _data13_)
{
	...
	gint _tmp1_;
	self = _data13_->self;
	_tmp0_ = gtk_combo_box_get_active ((GtkComboBox*) _data13_->sexSelect);
	_tmp1_ = _tmp0_;
	self->sex = _tmp1_ + 1;
}
...
static void
___lambda79__gtk_dialog_response (GtkDialog* _sender,
                                  gint response_id,
                                  gpointer self)
{
...
add_user_dialog_construct (GType object_type)
{
	...
	_data13_->cfpwd = _tmp22_;
	_tmp23_ = _data13_->cfpwd;
	gtk_entry_set_visibility (_tmp23_, FALSE);
	_tmp24_ = grid;
	_tmp25_ = _data13_->cfpwd;
	...
	_tmp42_ = grid;
	_tmp43_ = _data13_->yearSelect;
	gtk_grid_attach (_tmp42_, (GtkWidget*) _tmp43_, 1, 4, 1, 1);
	_tmp44_ = _data13_->yearSelect;
	g_signal_connect_data ((GtkComboBox*) _tmp44_, "changed", (GCallback) ___lambda77__gtk_combo_box_changed, block13_data_ref (_data13_), (GClosureNotify) block13_data_unref, 0);
	_tmp45_ = (GtkComboBoxText*) gtk_combo_box_text_new ();
	g_object_ref_sink (_tmp45_);
	_data13_->sexSelect = _tmp45_;
	gtk_combo_box_text_append_text (_data13_->sexSelect, _ ("Man"));
	gtk_combo_box_text_append_text (_data13_->sexSelect, _ ("Woman"));
	gtk_combo_box_set_active ((GtkComboBox*) _data13_->sexSelect, 0);
	_tmp46_ = grid;
	...
	_tmp49_ = grid;
	gtk_grid_attach (_tmp49_, (GtkWidget*) _data13_->sexSelect, 1, 5, 1, 1);
	g_signal_connect_data ((GtkComboBox*) _data13_->sexSelect, "changed", (GCallback) ___lambda78__gtk_combo_box_changed, block13_data_ref (_data13_), (GClosureNotify) block13_data_unref, 0);
	_tmp50_ = grid;
	...
	_tmp62_ = self->dlg1;
	g_signal_connect_data (_tmp62_, "response", (GCallback) ___lambda79__gtk_dialog_response, block13_data_ref (_data13_), (GClosureNotify) block13_data_unref, 0);
