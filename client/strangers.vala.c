...
static void __lambda15_ (StrangersDialg* self,
                  gint rid);
static gboolean __lambda16_ (StrangersDialg* self,
                      GtkTreeModel* m,
                      GtkTreePath* p,
                      GtkTreeIter* iter);
static gboolean ___lambda16__gtk_tree_model_foreach_func (GtkTreeModel* model,
                                                   GtkTreePath* path,
                                                   GtkTreeIter* iter,
                                                   gpointer self);
static void ___lambda15__gtk_dialog_response (GtkDialog* _sender,
                                       gint response_id,
                                       gpointer self);
static void __lambda17_ (StrangersDialg* self,
                  GtkTreeView* tree,
                  GtkTreePath* path,
...
void my_grid_add_friend (MyGrid* self,
                         UserMsg* user1,
                         gboolean tell);
static void ___lambda17__gtk_tree_view_row_activated (GtkTreeView* _sender,
                                               GtkTreePath* path,
...
static gboolean
___lambda16__gtk_tree_model_foreach_func (GtkTreeModel* model,
                                          GtkTreePath* path,
                                          GtkTreeIter* iter,
                                          gpointer self)
{
	gboolean result;
	result = __lambda16_ ((StrangersDialg*) self, model, path, iter);
	return result;
}
             ...
             gint rid)
{
	...
	_tmp1_ = self->store1;
	gtk_tree_model_foreach (G_TYPE_CHECK_INSTANCE_TYPE (_tmp1_, gtk_tree_model_get_type ()) ? ((GtkTreeModel*) _tmp1_) : NULL, ___lambda16__gtk_tree_model_foreach_func, self);
}


static void
___lambda15__gtk_dialog_response (GtkDialog* _sender,
                                  gint response_id,
                                  gpointer self)
{
	__lambda15_ ((StrangersDialg*) self, response_id);
}


static void
__lambda17_ (StrangersDialg* self,
             GtkTreeView* tree,
             GtkTreePath* path,
             GtkTreeViewColumn* col)
{
...
static void
___lambda17__gtk_tree_view_row_activated (GtkTreeView* _sender,
                                          GtkTreePath* path,
                                          GtkTreeViewColumn* column,
                                          gpointer self)
{
	__lambda17_ ((StrangersDialg*) self, _sender, path, column);
}
...
strangers_dialg_create_dialg (StrangersDialg* self)
{
	...
	_tmp23_ = self->dlg1;
	g_signal_connect_object (_tmp23_, "response", (GCallback) ___lambda15__gtk_dialog_response, self, 0);
	g_signal_connect_object (view, "row-activated", (GCallback) ___lambda17__gtk_tree_view_row_activated, self, 0);
