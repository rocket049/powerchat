...
static gboolean __lambda12_ (Block8Data* _data8_);
...
static gboolean __lambda31_ (Block9Data* _data9_);
...
static gint __lambda26_ (Block11Data* _data11_);
...
static gint __lambda11_ (Block12Data* _data12_);
...
block7_data_unref (void * _userdata_)
{
	...
	if (g_atomic_int_dec_and_test (&_data7_->_ref_count_)) {
		_g_free0 (_data7_->name);
		_g_free0 (_data7_->desc);
		_g_free0 (_data7_->msg);
		_g_free0 (_data7_->msg_time);
...
__lambda27_ (Block7Data* _data7_)
{
	...
	UserMsg _tmp1_ = {0};
	_tmp0_ = search1;
	_tmp1_.id = _data7_->id;
	_tmp1_.sex = _data7_->sex;
	_g_free0 (_tmp1_.name);
	_tmp1_.name = _data7_->name;
	_g_free0 (_tmp1_.desc);
	_tmp1_.desc = _data7_->desc;
	_tmp1_.age = _data7_->age;
	_g_free0 (_tmp1_.msg_offline);
	_tmp1_.msg_offline = _data7_->msg;
	_g_free0 (_tmp1_.timestamp_offline);
	_tmp1_.timestamp_offline = _data7_->msg_time;
              ...
              const gchar* msg_time)
{
	...
	g_idle_add_full (G_PRIORITY_DEFAULT_IDLE, ___lambda12__gsource_func, block8_data_ref (_data8_), block8_data_unref);
...
static gboolean
__lambda31_ (Block9Data* _data9_)
{
	gboolean result = FALSE;
	MyGrid* _tmp0_;
	UserMsg _tmp1_ = {0};
            ...
            const gchar* msg_time)
{
	...
	g_idle_add_full (G_PRIORITY_DEFAULT_IDLE, ___lambda31__gsource_func, block9_data_ref (_data9_), block9_data_unref);
...
__lambda9_ (Block10Data* _data10_)
{
	...
	MyGrid* _tmp0_;
	_tmp0_ = grid1;
	my_grid_rpc_callback (_tmp0_, _data10_->typ, _data10_->from, _data10_->msg);
	result = FALSE;
	return result;
}
...
__lambda26_ (Block11Data* _data11_)
{
	...
	gint result = 0;
	self = _data11_->self;
	Client_SearchPersons (_data11_->key, (void*) search_add);
	result = 0;
	return result;
}
...
static gpointer
___lambda26__gthread_func (gpointer self)
{
	gpointer result;
	result = (gpointer) ((gintptr) __lambda26_ (self));
                                 ...
                                 const gchar* key)
{
	...
	_g_free0 (_data11_->key);
	_data11_->key = _tmp0_;
	_tmp1_ = g_thread_new ("search_person", ___lambda26__gthread_func, block11_data_ref (_data11_));
	thread = _tmp1_;
...
{
	gpointer result;
	result = (gpointer) ((gintptr) __lambda13_ ((ChatClient*) self));
	g_object_unref (self);
	return result;
}
...
chat_client_get_stranger_msgs_async (ChatClient* self)
{
	...
	GThread* _tmp0_;
	g_return_if_fail (self != NULL);
	_tmp0_ = g_thread_new ("get_strangers", ___lambda13__gthread_func, g_object_ref (self));
	thread = _tmp0_;
	_g_thread_unref0 (thread);
}
...
{
	gpointer result;
	result = (gpointer) ((gintptr) __lambda30_ ((ChatClient*) self));
	g_object_unref (self);
	return result;
}
...
chat_client_get_friends_async (ChatClient* self)
{
	...
	GThread* _tmp0_;
	g_return_if_fail (self != NULL);
	_tmp0_ = g_thread_new ("get_friends", ___lambda30__gthread_func, g_object_ref (self));
	thread = _tmp0_;
	_g_thread_unref0 (thread);
}
...
static gint
__lambda11_ (Block12Data* _data12_)
{
	ChatClient* self;
	gint result = 0;
	self = _data12_->self;
	Client_QueryID (_data12_->uid, _data12_->msg, (void*) stranger_add);
	result = 0;
	return result;
}
                                 ...
                                 const gchar* msg)
{
	...
	_g_free0 (_data12_->msg);
	_data12_->msg = _tmp0_;
	if (_data12_->uid == ((gint64) 0)) {
		block12_data_unref (_data12_);
		_data12_ = NULL;
		return;
	}
	_tmp1_ = g_thread_new ("search_person", ___lambda11__gthread_func, block12_data_ref (_data12_));
	thread = _tmp1_;
	_g_thread_unref0 (thread);
	block12_data_unref (_data12_);
	_data12_ = NULL;
