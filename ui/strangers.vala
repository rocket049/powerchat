...
public class StrangersDialg:GLib.Object{
	...
	public void create_dialg(){
		...
		view.insert_column_with_attributes (0, "名称", cell, "text",0,"background",7);
		view.insert_column_with_attributes (1, "留言", cell, "text",1,"background",7);
		view.insert_column_with_attributes (2, "时间", cell, "text",2,"background",7);
		view.insert_column_with_attributes (3, "ID", cell, "text",3,"background",7);
		view.insert_column_with_attributes (4, "性别", cell, "text",4,"background",7);
		view.insert_column_with_attributes (5, "年龄", cell, "text",5,"background",7);
		view.insert_column_with_attributes (6, "自述", cell, "text",6,"background",7);
