...
public class SearchDialg:GLib.Object{
	...
	public SearchDialg(){
		...
		view.insert_column_with_attributes (0, "ID", cell, "text",0);
		view.insert_column_with_attributes (1, "名称", cell, "text",1);
		view.insert_column_with_attributes (2, "性别", cell, "text",2);
		view.insert_column_with_attributes (3, "年龄", cell, "text",3);
		view.insert_column_with_attributes (4, "自述", cell, "text",4);
